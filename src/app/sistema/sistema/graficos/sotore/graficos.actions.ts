...
enum graficosAction{
    ...
    loadGraficoParcelada = '[Graficos] Carregando gráfico de parceladas',
    successGraficoParcelas = '[Graficos] Sucesso no carremento do gráfico de parceladas',
}
...
export const loadGraficoParcelada = createAction(graficosAction.loadGraficoParcelada, props<{payload:ParamMesAno}>());
export const successGraficoParcelas = createAction(graficosAction.successGraficoParcelas, props<{payload: IGraficoParceladas}>());
